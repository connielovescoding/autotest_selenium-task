...
public class TEST10000 implements TestCase {
    ...
    public boolean run() throws Exception {
        ...
        return webDriver.getCurrentUrl().contains("booking.com");
    }
